...
def case_all():
    ...
    discovery=unittest.defaultTestLoader.discover(testcase_dir,pattern='dating_zhb.py',top_level_dir=None)
    return discovery
#HTMLTestRunner测试报告
...
if __name__ == '__main__':
    ...
    result = BeautifulReport(case_all())
    result.report(filename='3D测试报告', description='3D测试报告', log_path='../run_report')
